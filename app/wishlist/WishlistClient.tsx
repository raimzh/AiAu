...
export default function WishlistClient({ allProducts }: { allProducts: Product[] }) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      <p className="text-sm text-gray-500 mb-8">{wishlistProducts.length} {plural(wishlistProducts.length, JEWELLERY)}</p>
      ...
      {wishlistProducts.length > 0 ? (
        ...
        <div className="text-center py-24">
          ...
          <p className="text-sm text-gray-500 mb-8">Нажимайте ♡ на карточках, чтобы сохранять украшения</p>
          <Link
            href="/catalog"
