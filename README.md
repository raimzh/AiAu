...
app/
  ...
  size-guide/
    page.tsx                      — Размер кольца: таблица, советы, крошки
    SizeCalculator.tsx            — Пересчёт обхвата/диаметра в размер (client component)
...
| `/size-guide` | Размер кольца: как измерить, таблица, калькулятор |
| `/about` | О магазине |
